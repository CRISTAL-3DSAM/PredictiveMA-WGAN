...
import time
from SRVF_WGAN_CMU import SRVF_WGAN
...
if Short_Term:
    ...
    flags.DEFINE_string(flag_name='checkpoint_name', default_value='model-110000', docstring='name of checkpoint file, model-XXXXX')
    ...
    if Training:
        ...
        flags.DEFINE_integer(flag_name='batch_size', default_value=704, docstring='number of samples in test set')
    ...
    if Training:
        ...
        flags.DEFINE_boolean(flag_name='is_train', default_value=False, docstring='training mode')
        flags.DEFINE_integer(flag_name='batch_size', default_value=677, docstring='number of samples in test set')
